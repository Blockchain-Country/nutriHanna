...
const HeroSection = ({ onBookingOpen }) => {
    ...
    useEffect(() => {
        ...
        const t2 = setTimeout(
            () => image.classList.add('hero__image-col--visible'),
            380,
        )
        return () => {
            clearTimeout(t1)
            ...
            <div className="hero__inner">
                <div ref={contentRef} className="hero__content">
                    ...
                    <p className="hero__subtitle">
                        Персональная нутрициология для тех, кто хочет изменить
                        качество жизни навсегда. Без жёстких диет - только
                        научный подход и устойчивый результат.
                    </p>
